...
import 'package:flulabs/ui/auth/login/login_viewmodel.dart';
...
class _SignInState extends State<SignIn> with SingleTickerProviderStateMixin {
                          ...
                          noTokenCallback: () {
                            _animation.addStatusListener((status) {
                              if (status == AnimationStatus.dismissed ||
                                ...
                                store.dispatch(new ChangeScreenStateAction(
                                    ScreenState.SINGIN));
                              }
                            });
                  ...
                  new Align(
                    ...
                    child: new Transform(
                      transform: new Matrix4.translationValues(
                          0.0, _animation.value, 0.0),
                      child: SingleChildScrollView(
                        child: new Column(
                          children: <Widget>[
                            Padding(
                              padding: const EdgeInsets.only(
                                  left: 65.0, right: 65.0, top: 16.0),
                              child: new Image(
                                image:
                                    AssetImage("assets/images/logo_group.png"),
                              ),
                            ),
                            viewModel.type == ScreenState.SINGIN
                                ? new Column(
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            loginBtn(() {
                                              viewModel.login(viewModel.email,
                                                  viewModel.password);
                                            })
                                          ],
                                        ),
  ...
  Widget emailInput(LoginViewModel viewModel) => Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
                bottom: BorderSide(
                    color: new Color(_getColor(
                        viewModel.status, viewModel.emailError, _emailNode)),
                    width: 1.0)),
          ),
          child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
                bottom: BorderSide(
                    color: new Color(_getColor(
                        viewModel.status, viewModel.passwordError, _passNode)),
                    width: 1.0)),
          ),
          child: Padding(
            padding: const EdgeInsets.only(left: 16.0, bottom: 8.0),
            child: new TextField(
              ...
              decoration: new InputDecoration(
                  labelText: password,
                  labelStyle: new TextStyle(
                      color: new Color(_getColor(viewModel.status,
                          viewModel.passwordError, _passNode))),
                  border: InputBorder.none),
              onChanged: (password) {
  ...
  Widget signupBtn(VoidCallback callback) =>
      actionButton(callback, primaryPink, signup);
  Widget loginBtn(VoidCallback callback) =>
      actionButton(callback, primaryBlue, login);
  ...
  Widget forgotPassword() => Padding(
        ...
        child: new GestureDetector(
          child: new Text(
            forgot_password,
            style: TextStyle(fontSize: 14.0, color: Color(primaryBlue)),
          ),
          onTap: () {
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            new Text(
              and_with_spaces,
              style:
                  TextStyle(fontSize: 12.0, color: Color(botomAccentLightGray)),
            ),
            GestureDetector(
              child: new Text(
                policy,
